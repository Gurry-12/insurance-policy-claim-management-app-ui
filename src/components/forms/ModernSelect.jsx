...
const ModernSelect = ({ 
  ...
  const customStyles = {
    control: (base, state) => ({
      ...base,
      borderRadius: '8px',
      borderColor: error ? 'var(--bs-form-invalid-border-color, #dc3545)' : state.isFocused ? 'var(--ip-primary, #0d6efd)' : '#e2e8f0',
      boxShadow: state.isFocused ? (error ? '0 0 0 0.25rem rgba(220, 53, 69, 0.25)' : '0 0 0 3px rgba(13, 110, 253, 0.15)') : '0 1px 2px 0 rgba(0, 0, 0, 0.05)',
      minHeight: '44px',
      transition: 'all 0.2s ease-in-out',
      '&:hover': {
        borderColor: error ? 'var(--bs-form-invalid-border-color, #dc3545)' : (state.isFocused ? 'var(--ip-primary, #0d6efd)' : '#cbd5e1')
      },
