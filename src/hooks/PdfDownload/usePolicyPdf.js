  ...
  const downloadPolicy = (policy) => {
    ...
    autoTable(doc, {
      ...
      body: [
        ...
        [
          "Total Premium Paid",
          policy.totalPremiumPaid != null
            ? `Rs. ${Number(policy.totalPremiumPaid).toLocaleString("en-IN")}`
            : "-",
        ],
        [
          "Remaining Coverage",
          policy.remainingClaimAmount != null
            ? `Rs. ${Number(policy.remainingClaimAmount).toLocaleString("en-IN")}`
            : "-",
        ],
        ...
        [
          "Issued Date",
          policy.createdDate
            ? new Date(policy.createdDate).toLocaleDateString("en-IN")
            : "-",
        ],
      ],
      headStyles: {
